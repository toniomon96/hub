...
After pushing this repo to GitHub as `toniomon96/hub-prompts`:

```bash
# 1. Register the repo in Hub's registry
hub registry add toniomon96/hub-prompts --sensitivity low

# 2. Wire all scheduled prompts
hub registry wire toniomon96/hub-prompts daily-triage       --trigger "cron:0 8 * * 1-5"
hub registry wire toniomon96/hub-prompts weekly-review      --trigger "cron:0 17 * * 5"
hub registry wire toniomon96/hub-prompts commitment-tracker --trigger "cron:0 20 * * *"
hub registry wire toniomon96/hub-prompts context-review     --trigger "cron:0 9 1 * *"
hub registry wire toniomon96/hub-prompts provocation        --trigger "cron:30 7 * * 2,4,6"
hub registry wire toniomon96/hub-prompts feedback-review    --trigger "cron:0 9 * * 0"
hub registry wire toniomon96/hub-prompts theorize           --trigger "cron:0 8 1,15 * *"

# 3. Wire manual prompts (no cron)
hub registry wire toniomon96/hub-prompts meeting-prep       --trigger manual
hub registry wire toniomon96/hub-prompts kickoff            --trigger manual
hub registry wire toniomon96/hub-prompts cross-repo-audit   --trigger manual
hub registry wire toniomon96/hub-prompts decision-log       --trigger manual
hub registry wire toniomon96/hub-prompts authority-review   --trigger manual
hub registry wire toniomon96/hub-prompts annual-review      --trigger manual

# 4. Wire event-triggered prompts
hub registry wire toniomon96/hub-prompts process-capture    --trigger capture.actionable

# 5. Verify
hub registry list --repo toniomon96/hub-prompts
```
