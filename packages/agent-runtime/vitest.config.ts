...
/**
 * Same node-builtin shim used by @hub/db and @hub/capture — Vite's transformer
 * strips the `node:` prefix and can't resolve `node:sqlite`. We redirect to a
 * virtual module that goes through createRequire.
 */
